package com.go.ride.go.helpers;
...
public class Constants {
    ...
    public static String getUberClientId(Activity activity) {
        return getManifestData(activity, Secrets.UBER_CLIENT_ID);
    }

    public static String getUberClientSecret(Activity activity) {
        return getManifestData(activity, Secrets.UBER_CLIENT_SECRET);
    }

    public static String getUberRedirectUrl(Activity activity) {
        return getManifestData(activity, Secrets.UBER_REDIRECT_URL);
    }
